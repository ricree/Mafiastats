...
{	
	...
	$(".NameChooser").each(function(){
			var node = this;
			$(this).children(":first").jsonSuggest("http://localhost:8000/player/name_lookup/",{wildCard:'*',maxResults:10,ajaxResults:true,useJQueryAjax:true,JQueryAjaxParam : "text",onSelect:CopyToBox(node)}).keyup(function(e){
	if(e.which == 0xD){
		CopyToBox(node)(null);
	}
});
