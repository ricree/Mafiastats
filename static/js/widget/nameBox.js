...
{	
	...
	$(".NameChooser").each(function(){
			var node = this;
			$(this).children(":first").jsonSuggest("/player/name_lookup/",{wildCard:'*',maxResults:10,ajaxResults:true,useJQueryAjax:true,JQueryAjaxParam : "text",onSelect:CopyToBox(node)}).keyup(function(e){
	if(e.which == 0xD){
		CopyToBox(node)(null);
	}
});
