...
urlpatterns = patterns('',
    ...
    # Uncomment the next line to enable the admin:
     ...
     url(r'^account/badge/?$','Mafiastats.mafiaStats.views.badge',name='account_badge'),
     url(r'^account/badge/(?P<pk>\d*)/?$','Mafiastats.mafiaStats.views.badge',name='account_badge_edit'),
     url(r'^account/badge/(?P<pk>\d*)/delete/?$','Mafiastats.mafiaStats.views.badge_delete',name='account_badge_delete'),
     url(r'account/badge/preview/?$','Mafiastats.mafiaStats.views.badge_preview',name='account_badge_preview'),
